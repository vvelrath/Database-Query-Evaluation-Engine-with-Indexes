...
public class Main {
	...
	public static Boolean buildFlag=false;
...
//			}
	...
	public static void main(String[] args) throws ParseException {
		...
		if(buildFlag == true)
		{
			TableDetailsVisitor tabVisit = new TableDetailsVisitor(dataDir);
			...
			BuildIndexes bldIdxer = new BuildIndexes(indexDir);
			bldIdxer.create();
		}
		else
		{	
				...
				while ((stmt = parser.Statement()) != null) {
					...
					if (stmt instanceof CreateTable) {
						...
						if (select instanceof PlainSelect) {
							...
							SelectEvaluator sel_visitor = new SelectEvaluator(operator,dataDir, tables,indexDir);
